...
export default function Onboarding() {
  ...
  const handleCreateCommunity = async () => {
    const code = (newCommunityCode.trim() || generateCodeFromName(newCommunityName)).toLowerCase();
    ...
    if (!/^[a-z0-9-_]+$/.test(code)) {
      setCodeError("Code must contain only lowercase letters, numbers, hyphens, and underscores");
      return;
    }
      ...
      <div className="min-h-screen bg-[#0f0a1a] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="max-w-md w-full text-center">
            ...
            <p className="text-grape-400 mb-8">
              Give your community a name, and we'll generate a unique code for people to join.
            </p>
              ...
              <div>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setCodeError("");
                    if (!isCodeCustomized) {
                      setNewCommunityCode(generateCodeFromName(val));
                    }
                  }}
              ...
              <div>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    const val = rawVal.toLowerCase().replace(/[^a-z0-9-_]/g, '');
                    if (val === "") {
                      setIsCodeCustomized(false);
                      setNewCommunityCode("");
                    } else {
                      setIsCodeCustomized(true);
                      setNewCommunityCode(val);
                    }
                    setCodeError("");
                  }}
                  onKeyDown={(e) => e.key === "Enter" && handleCreateCommunity()}
                ...
                />
                <p className="text-grape-600 text-xs mt-2">
                  Autogenerated from name. You can customize it (letters, numbers, hyphens, underscores).
                </p>
              </div>
            ...
            <button
              ...
              disabled={!newCommunityName.trim() || (!newCommunityCode.trim() && !generateCodeFromName(newCommunityName))}
